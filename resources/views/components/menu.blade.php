        ...
        <div class="h-screen bg-gray-800">
            ...
            <nav class="">
                ...
                <div x-data="{ open: false }">
                    ...
                    <div x-show="open" class="bg-gray-700">
                        <a class="py-2 px-16 block text-sm text-gray-100 hover:bg-blue-500 hover:text-white" href="#">All
                            Accounts</a>
                        <a class="py-2 px-16 block text-sm text-gray-100 hover:bg-blue-500 hover:text-white" href="#">Create
                            Account</a>
                        <a class="py-2 px-16 block text-sm text-gray-100 hover:bg-blue-500 hover:text-white" href="#">Accounts
                            Roles</a>
                    </div>
                </div>
