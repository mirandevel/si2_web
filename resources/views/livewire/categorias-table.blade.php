...
<div class="container antialiased font-sans mx-auto px-4 sm:px-8">
    <div class="py-8">
        ...
        <div class="my-2 flex sm:flex-row flex-col">
            ...
            <button type="button" class="border bg-white text-gray-800 font-bold rounded-md px-4 ml-1 transition duration-500 ease select-none hover:bg-green-300 focus:outline-none focus:shadow-outline show-create">
                Crear +
            </button>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="border-b border-gray-200 bg-white text-sm">
                                <div class="flex items-center justify-center">
                                    ...
                                    <div class="m-3">
                                        <button class="bg-white text-gray-800 font-bold rounded border-b-2 border-red-500 hover:border-red-600 hover:bg-red-500 hover:text-white shadow-md py-1 px-1 inline-flex items-center">
            ...
            <div class="flex place-content-center">
                <form wire:submit.prevent="storeCategoria" class="w-full max-w-lg">
                    ...
                    <div class="flex items-center justify-end p-1 text-center bg-gray-200">
                        <div class="m-3">
                            <button type="submit" class="bg-white text-gray-800 font-bold rounded border-b-2 border-green-500 hover:border-green-600 hover:bg-green-500 hover:text-white shadow-md py-1 px-1 inline-flex items-center @if (!$errors->has('nombre')) close-create @endif">
